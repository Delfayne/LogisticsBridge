package org.dv.minecraft.logisticsbridge.mixin.core;
...
public class MixinConfigPlugin implements IMixinConfigPlugin {
    ...
    private static final String PACKAGE_PREFIX = "org.dv.minecraft.logisticsbridge.";
    ...
    private static final ImmutableMap<String, Consumer<PotentialMixin>> MIXIN_PROCESSING_MAP = ImmutableMap.<String, Consumer<PotentialMixin>>builder()
            ...
            .put("Lorg/dv/minecraft/logisticsbridge/annotation/ClientOnlyMixin;", p -> p.isClientOnly = true)
    ...
    private void considerClass(String pathString) throws IOException {
        try(InputStream stream = MixinConfigPlugin.class.getClassLoader().getResourceAsStream("org/dv/minecraft/logisticsbridge/mixin/" + pathString)) {
            if(stream == null)
                return;
    ...
    public List<String> getMixins() {
        ...
        if(phase == MixinEnvironment.Phase.DEFAULT) {
            ...
            List<String> list = allMixins.stream()
                    ...
                    .map(clz -> clz.replace("org.dv.minecraft.logisticsbridge.mixin.", ""))
