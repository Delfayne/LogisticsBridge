...
import org.dv.minecraft.logisticsbridge.item.FakeItem;
import org.dv.minecraft.logisticsbridge.module.AdvItemExtractionUpgrade;
import org.dv.minecraft.logisticsbridge.module.BufferUpgrade;
import org.dv.minecraft.logisticsbridge.module.CraftingManagerPipeSign;
...
import org.dv.minecraft.logisticsbridge.proxy.CommonProxy;
import org.dv.minecraft.logisticsbridge.proxy.GTCEUMultiblockProgressProvider;
import org.dv.minecraft.logisticsbridge.proxy.GTCEUProgressProvider;
...
public class LogisticsBridge {
    ...
    private static final String CLIENT_PROXY_CLASS = "org.dv.minecraft.logisticsbridge.proxy.ClientProxy";
    private static final String SERVER_PROXY_CLASS = "org.dv.minecraft.logisticsbridge.proxy.ServerProxy";
